...
def vvh_uniaxial():
    ...
    axial_displacements = cm.de_tempo_para_deslocamento(taxa_def=strain_rate, tempos=times, tamanho_inicial=initial_height)


    axial_stresses, transversal_stretches = uniaxial.uniaxial_procedure(times,axial_stretches, meu_mat)
